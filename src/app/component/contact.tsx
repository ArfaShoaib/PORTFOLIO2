...
const ContactPAge = () => {
  ...
  <section className="text-gray-600 body-font relative">
    <div className="absolute inset-0 bg-gray-100 ml-4">
      <iframe
        width="60%"
        height="100%"
        title="map"
      ...
      ></iframe>
<div className="absolute top-11 left-5 z-10 bg-white bg-opacity-75 p-4 rounded shadow-md">
   <div className="bg-white bg-opacity-75 p-4 rounded">
          <p className="text-gray-800 font-medium">Email:arfa@gmail.com</p>
    ...
    <div className="container px-5 py-24 mx-auto flex">
      <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
        ...
        <form action="https://formspree.io/f/xgvewzje"
  method="POST">
        ...
        <button className="text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-800 rounded text-lg">Send Message</button>
        </form>
      </div>
    </div>
  </section>
